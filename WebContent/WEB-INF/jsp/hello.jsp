   ...
   <title>首页</title>
    ...
    $(function () {
        ...
        $("#affirm").click(function(){   //确认创建收藏夹
            ...
            var ispublic=$('input:radio[id="public"]:checked').val();//公开
            var isprivate=$('input:radio[id="private"]:checked').val();//私密
            var status;
            alert(favoritesname);
            alert(description);
            if(ispublic!=null){
            ...
            <div class="tab-content">
                ...
                <div id="commend" class="container tab-pane active"><br>
                    ...
                    <div class="content">
                        ...
                        <p class="text-secondary mt-2">${que.commentnumb}回答</p>
                        ...
                        <span class="tip1 mt-2" onclick="openComment(${que.userid})">✉${que.commentnumb}评论</span><span class="tip2 mt-2" onclick="openShare()">➢分享</span><span
                            class="tip3 mt-2" onclick="openModak()">★收藏</span>
                    </div>
                    
                    <!-- 回答的评论 --> 
                   
                <div id="comments${que.userid}" style="display: none;border:1px solid #D9D9D9;margin-left:15px;margin-right:15px " >
                    ...
                    <div id="comment" class="ml-4">
                        <input class="mt-2" type="image"
                            ...
                            width:30px;height:30px;float:left;" />
                        <p  id="commentName" class="ml-2" style="padding-top:10px;">&nbsp;${com.userid}<span id="commentTime" style="padding-left:350px">20小时前</span></p>  
                        <br />
                        <p id="content" style="padding-left: 40px;padding-top:5px;font-size:16px">${com.commentcontent}</p>
                        <div class="mt-2">
                            <span onclick="like()" style="padding-left:40px;padding-top:10px">👍<span id="like">${com.prisenumb}</span></span>
                        ...
                        <c:if   test="${com.commentid eq rcom.commentid}">
                            ...
                            <input class="mt-2" type="image"
                                src="F:\大三上\JavaScript\login\images\sculpture.jpg" style="
                                width:30px;height:30px;float:left;" />
                            <p id="replyer" class="ml-2" style="padding-top:10px;">&nbsp;${rcom.userid}<span class="text-muted">回复</span><span id="replyed">北儿京儿人儿</span>
