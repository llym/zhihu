...
<div class="container" style="background-color: white;height: 400px;width: 1000px;">
    ...
    <div class="layui-upload mt-5" >
        <button type="button"  id="test1" style="border:0;outline: 0;background-color: transparent">
      ...
      <!--个人主页头像-->
      <div>
    <div class="layui-upload col-sm-4 mb-5" style=" float:left;margin-top: -100px">
      <button type="button"  id="test2" style="margin-left: 50px; border:0;outline: 0;background-color: transparent">
    ...
    <div class="col-sm-8" style="float: right">
        ...
        <div id="demo" class="collapse"><lable class="font-weight-bold">所在的行业</lable></div>
        <a href="#demo" id="change-text" data-toggle="collapse" onclick="fold()">﹀ 查看详细资料</a>
        <a class="btn btn-outline-primary edit pull-right" style="float:right" href="#">编辑个人资料</a>
    </div> 
  </div>     
</div>
<!--正文-->
<div class="container mt-5" style="background-color: white;height: 360px;width: 1000px;">
  <div class="row">
  ...
  <div class="col-sm-3 ml-4">
      ...
      <div class="mt-2 text-left">
          <div class="dropdown-divider "></div>
          <a class="mt-5 ml-3 text-muted" href="#">关注的话题<span class="ml-5">0</span></a><br/><br/>
          <div class="dropdown-divider "></div>
          <a class="mt-5 ml-3 text-muted" href="#">关注的专栏<span class="ml-5">0</span></a><br/><br/>
          <div class="dropdown-divider "></div>
          <a class="mt-5 ml-3 text-muted" href="#">关注的问题<span class="ml-5">0</span></a><br/><br/>
          <div class="dropdown-divider "></div>
          <a class="mt-5 ml-3 text-muted" href="#">关注的收藏<span class="ml-5">0</span></a><br/><br/>
          <div class="dropdown-divider "></div>
          <a class="mt5 ml-3 text-muted" href="#">主页被浏览<span>0</span>次</a><br/><br/>
          <div class="dropdown-divider "></div>
      </div>
